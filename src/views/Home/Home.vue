    ...
    <el-col :span="8">
      ...
      <el-card shadow="hover" class="left-bottom">
        <el-table :data="tableData" style="width: 100%">
          <el-table-column :prop="key" :label="val" v-for="(val, key) in tableLabel" :key="key" show-overflow-tooltip></el-table-column>
        </el-table>
      </el-card>
    </el-col>
    <el-col :span="16">
      <div class="right-top">
        <el-card shadow="hover" v-for="item in countData" :key="item.name" class="right-top-card" :body-style="{ display: 'flex', padding: 0 }">
